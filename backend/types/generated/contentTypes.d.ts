...
export interface ApiArticuloArticulo extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Articulos premium con categorizacion editorial, autor y SEO';
  ...
  attributes: {
    ...
    slug: Schema.Attribute.UID<'titulo'> &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    tiempo_lectura: Schema.Attribute.Integer;
...
export interface ApiAutorAutor extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Autores del portal y equipo editorial';
    displayName: 'Autor';
    pluralName: 'autores';
    singularName: 'autor';
  };
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    redes_sociales: Schema.Attribute.Component<'social.social-link', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiCategoriaCategoria extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Categorias editoriales para agrupar articulos y documentos';
...
export interface ApiDocumentoDocumento extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Documentos descargables y archivos PDF para el portal editorial';
...
export interface ApiEventoEvento extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Eventos editoriales, lanzamientos, y actividades programadas';
    displayName: 'Evento';
    pluralName: 'eventos';
    singularName: 'evento';
  };
